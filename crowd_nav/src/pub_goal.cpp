...
class PubGoal : public rclcpp::Node
{
  public:
    ...
    : Node("pub_goal")
    {
      ...
      set_goal_pose_srv_ = create_service<crowd_nav_interfaces::srv::GoalReq>("set_goal_pose",
  ...
  private:
    ...
    void set_goal_pose_cb(std::shared_ptr<crowd_nav_interfaces::srv::GoalReq::Request> req,
